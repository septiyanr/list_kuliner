...
class DetailPage extends StatelessWidget {
        ...
        body: SingleChildScrollView(
          child: Column(
            ...
            Row(
              ...
              children: [
                atrributesIcon(Icons.access_time_filled, makanan.waktubuka),
                atrributesIcon(Icons.local_fire_department_rounded, makanan.kalori),
                atrributesIcon(Icons.monetization_on, makanan.harga),
              ],
              ),
              Container(
  ...
  Column atrributesIcon(IconData icon, String teks) {
    return Column(
                children: [
